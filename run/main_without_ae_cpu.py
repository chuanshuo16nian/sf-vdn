...
import pylab
from Parameters_cpu import Parameters
...
USE_GPU = False
if WIN:
    base_path = 'F://bs//sf-vdn//run//saved_models//'
else:
    base_path = '/home/admin1/zp/run/saved_models/'
...
class VDN_DSR(object):
    ...
    def train(self, replay_memory):
        ...
        fai1_loss, fai2_loss, _, __ = self.sess.run([self.Loss_fai_1, self.Loss_fai_2, self.train_fai_1, self.train_fai_2],
        ...
        self.fai1_loss += fai1_loss
        self.fai2_loss += fai2_loss
    ...
    def print_fai_loss(self):
        if self.step % 50000 == 0:
            print('mean loss of fai1: %f fai2: %f' % (self.fai1_loss/50000, self.fai2_loss/50000))
