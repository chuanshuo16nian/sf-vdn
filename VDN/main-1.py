...
class VDN(object):
    def __init__(self):
        ...
        self.env = GameEnv()
        self.progress = ''
        self.Num_action = Parameters1.Num_action ######################
        ...
        self.Num_Exploration = Parameters1.Num_start_training
        self.Num_Training = Parameters1.Num_training
        self.Num_Testing = Parameters1.Num_test

        self.learning_rate = Parameters1.Learning_rate
        self.gamma = Parameters1.Gamma

        self.first_epsilon = Parameters1.Epsilon
        self.final_epsilon = Parameters1.Final_epsilon
        self.epsilon = Parameters1.Epsilon

        self.Num_plot_episode = Parameters1.Num_plot_episode

        self.Is_train = Parameters1.Is_train
        ...
        self.state_set = []
        self.Num_skipping = Parameters1.Num_skipFrame
        self.Num_stacking = Parameters1.Num_stackFrame

        # parameters for experience replay
        self.Num_replay_memory = Parameters1.Num_replay_memory
        self.Num_batch = Parameters1.Num_batch
        self.replay_memory = []

        # parameters for target network
        self.Num_update_target = Parameters1.Num_update

        # parameters for network
        self.input_size = Parameters1.Input_size
        # self.Num_colorChannel = Parameters.Num_colorChannel

        self.first_dense = Parameters1.first_dense
        self.first_LSTM =Parameters1.first_LSTM
        self.second_dense = Parameters1.second_dense
        self.output_dense = Parameters1.output_dense

        self.GPU_fraction = Parameters1.GPU_fraction
